...
* Se encarga de ir demandando a JLex los lexemas válidos a analizar y genera el código necesario para el análisis sintáctico y semántico y el CI
* Analiza las reglas de la gramática del lenguaje a compilar y genera una serie de acciones a partir del análisis de dichas reglas
* Distingue entre terminales (devueltos por JLex) y no terminales, que son las reglas de la gramática
* Dentro de cada regla, puede ejecutar código Java para realizar su trabajo de análisis
...
* Después de la última regla de producción se termina con  ;
